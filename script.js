...
function display(datos,letra){
    ...
    <div class="row animate__animated animate__fadeIn">
              <div class="col-md-6 col-12 d-flex flex-column align-items-center align-items-md-start text-white">
                <div class="fs-1 fw-normal text-capitalize"> ${datos.weather.description}</div>
                <div class="fs-6">${datos.city}</div>
                <div><!-- fecha --> ${new Date().toDateString()}</div>
                <div class="display-1"><p class="fw-bold overflow-hidden">${Math.round(datos.main.temp)} °${letra}</p></div>
                <img src="http://openweathermap.org/img/wn/${datos.weather.icon}@4x.png" alt="weather condition icon">
              </div>
              <div class="col d-flex flex-column align-items-center align-items-md-end text-end">
                <div class="d-flex gap-2 mb-4 justify-content-md-end">
                  ...
                  <div>
                    <div>Sensación</div>
                    <div class="fs-3 fw-semibold">${Math.round(datos.main.feels_like)} °${letra}</div>
                  </div>
                </div>
                <div class="d-flex gap-2 mb-4 justify-content-md-end">
                  ...
                  <div>
                    <div>Humedad</div>
                    <div class="fs-3 fw-semibold">${datos.main.humidity} %</div>
                  </div>
                </div>
                <div class="d-flex gap-2 mb-4 justify-content-md-end">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="65.16" fill="currentColor" class="bi bi-thermometer-high" viewBox="0 0 16 16">
                    <path d="M9.5 12.5a1.5 1.5 0 1 1-2-1.415V2.5a.5.5 0 0 1 1 0v8.585a1.5 1.5 0 0 1 1 1.415z"/>
                    <path d="M5.5 2.5a2.5 2.5 0 0 1 5 0v7.55a3.5 3.5 0 1 1-5 0V2.5zM8 1a1.5 1.5 0 0 0-1.5 1.5v7.987l-.167.15a2.5 2.5 0 1 0 3.333 0l-.166-.15V2.5A1.5 1.5 0 0 0 8 1z"/>
                  </svg>
                  <div>
                    <div>Temp Max</div>
                    <div class="fs-3 fw-semibold">${Math.round(datos.main.temp_max)} °${letra}</div>
                  </div>
                </div>
                <div class="d-flex gap-2 mb-4 justify-content-md-end">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="65.16" fill="currentColor" class="bi bi-thermometer-low" viewBox="0 0 16 16">
                    <path d="M9.5 12.5a1.5 1.5 0 1 1-2-1.415V9.5a.5.5 0 0 1 1 0v1.585a1.5 1.5 0 0 1 1 1.415z"/>
                    <path d="M5.5 2.5a2.5 2.5 0 0 1 5 0v7.55a3.5 3.5 0 1 1-5 0V2.5zM8 1a1.5 1.5 0 0 0-1.5 1.5v7.987l-.167.15a2.5 2.5 0 1 0 3.333 0l-.166-.15V2.5A1.5 1.5 0 0 0 8 1z"/>
                  </svg>
                  <div>
                    <div>Temp Min</div>
                    <div class="fs-3 fw-semibold">${Math.round(datos.main.temp_min)} °${letra}</div>
                  </div>
                </div>
            </div>
            </div>
...
/* Carga por defecto el tiempo en Londres */
document.addEventListener('DOMContentLoaded',() => {
    dataObj('London',gradosC).then((datos) =>{
        input.value = 'London';
        displayC = true;
        display(datos,"C");
        btnCambiar.innerHTML = '<span class="fw-bold">°C</span> / °F';
